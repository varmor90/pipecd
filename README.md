...
> [`pkg/app/pipedv1/plugin/cloudrun/`](pkg/app/pipedv1/plugin/cloudrun/) and doesn't modify anything else in
> the upstream project. Everything outside that folder is the original PipeCD codebase, included here only
> so the plugin has somewhere to live and build against the real plugin SDK.
>
> 👉 **[Go straight to the plugin code](pkg/app/pipedv1/plugin/cloudrun/)**

---

## Where this came from

This plugin started as my proposal for Google Summer of Code 2026. The proposal — included in this repo as
[`pkg/app/pipedv1/plugin/cloudrun/docs/proposal.pdf`](pkg/app/pipedv1/plugin/cloudrun/docs/proposal.pdf) —
wasn't accepted; another contributor's was a better fit that year. Rather than shelve the idea, I decided to
build it anyway, on my own time, mostly to learn Go and cloud infrastructure properly by building something
real, rather than through tutorials.
